...
const ENTITIES = [
  ...
  { key: 'teams', label: 'Teams', icon: '⚾', cols: 'abbreviation (auto-generated), team_city, team_mascot, team_color, team_name (auto-generated), org_name, age_group, level, division (full path; use ; for multiple)' },
