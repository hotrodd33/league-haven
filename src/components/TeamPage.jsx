...
export default function TeamPage({ teamId, teamOrgId, onEditPlayer, onAddPlayer, onViewPlayer, refreshKey, onNavigateToTeam, onWatermarkLogoChange, onEditTeam }) {
  ...
  return (
    <div className="space-y-0">
      {/* Team header */}
      {team && <TeamHeader team={team} recentGames={recentGames} onContactTeam={() => setContactModal({ scope: 'team', scopeId: teamId, scopeLabel: team.name })} onEditTeam={onEditTeam} />}
...
/* ── Team Header ── */
function TeamHeader({ team, recentGames, onContactTeam, onEditTeam }) {
