...
import { needsScoreEntry } from '../utils/games.js';
import {
            ...
            <div key={dateKey} ref={(el) => { dateSectionRefs.current[dateKey] = el; }}>
              ...
              <div className="hidden md:block">
                <div className="space-y-2">
                  {gamesByDate[dateKey].map(item => {
                    ...
                    const missingScoreClass = needsScoreEntry(game) ? '!border-signal-500 ring-1 ring-signal-500/40' : '';
                    return (
                      <div key={game.id} onClick={() => setSelectedGameId(game.id)}
                        className={`bg-gray-800 border border-gray-700 rounded-lg p-2 flex items-center gap-2 cursor-pointer hover:border-chrome-300 hover:shadow-sm transition-all ${missingScoreClass}`}>
              ...
              <div className="md:hidden space-y-2">
                {gamesByDate[dateKey].map(item => {
                  ...
                  return (
                    <div key={game.id} onClick={() => setSelectedGameId(game.id)}
                      className={`bg-gray-800 border border-gray-700 rounded-lg p-2 cursor-pointer hover:border-chrome-300 hover:shadow-sm transition-all ${missingScoreClass}`}>
